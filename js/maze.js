...
function Maze(width, height) {
  ...
  var x, y;
  // Loop through each column and create array element for it
  // Array element will be another empty array
  for (x=1; x <= width; x += 1) {
      this.spaces[x] = [];
      // Add one element to array for each space in the column
